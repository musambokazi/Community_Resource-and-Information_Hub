...
Here is a summary of the steps taken to get the application running natively on a Windows environment for local development.
...
With the environment pointing to a fresh SQLite database, initialize it and create the tables. Run the following commands using the virtual environment:
